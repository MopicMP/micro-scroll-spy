...
> Micro scroll position spy for navigation

[![npm version](https://badge.fury.io/js/micro-scroll-spy.svg)](https://www.npmjs.com/package/micro-scroll-spy)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install micro-scroll-spy
```

## Quick Start

```javascript
const { spy } = require('micro-scroll-spy');

// Basic usage
const result = spy('your input here');
console.log(result);
```
...
```javascript
const { spy, batch } = require('micro-scroll-spy');
